...
module.exports = function(basepath, packageName, moduleName) {
  return es.through(function(file){
    if (packageName===undefined) return this.emit('error', new Error("gulp-twoside: packageName is not provided."));
    ...
    if (moduleName!==undefined) {
      padpath = padpath.slice(0, slashLastIndex)+moduleName;
    }
